...
import { Loading, OrderStep } from '@/components'
...
const UserOrderDetail: React.FC = () => {
  ...
  const { data: order, isLoading } = useGetOrderByCodeQuery(orderCode || '')
      ...
      {order && (
        <div className='bg-white shadow-lg rounded-lg p-6'>
          ...
          <h2 className='text-xl md:text-2xl font-semibold mb-4'>
            Order Code: <span className='text-primary'>{order.data?.code}</span>
          </h2>
